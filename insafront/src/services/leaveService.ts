...
const API_BASE = 'http://127.0.0.1:1000/leave';

// 휴가 신청
export const submitLeave = async (data: AnnualLeaveRequestDTO): Promise<AxiosResponse<string>> => {
